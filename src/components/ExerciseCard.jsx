...
export default function (props) {
  ...
  return (
    <div className='flex flex-col rounded-md p-4 bg-slate-950 gap-4 sm:flex-wrap'>
        <div className='flex flex-col sm:flex-row sm:items-center sm:flex-wrap gap-x-4'>
            <h4 className='text-3xl hidden sm:inline sm:text-4xl md:text-5xl font-semibold text-slate-400'>
                0{i+1}
            </h4>
            <h2 className='capitalize truncate flex-1 max-w-full text-lg sm:text-xl md:text-2xl whitespace-nowrap sm:text-centre'>
